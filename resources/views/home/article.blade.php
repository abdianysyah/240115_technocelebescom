        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="card" data-aos="fade-up" data-aos-duration="900">
                    <img src="https://images.unsplash.com/photo-1509023464722-18d996393ca8?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            ...
            <div class="col-lg-4 mt-5">
                ...
                <div class="list-group">
                    <a href="{{route(" article-single",7)}}" class="list-group-item list-group-item-action"
                        data-aos="fade-left" data-aos-duration="0900">
                        <div class="d-flex w-100 justify-content-between">
                            <h5 class="mb-1">5 IDE Terbaik untuk Coding</h5>
                        </div>
                    </a>
                    <a href="#" class="list-group-item list-group-item-action" data-aos="fade-left"
                        data-aos-duration="0900">
                        <div class="d-flex w-100 justify-content-between">
                    ...
                    <a href="#" class="list-group-item list-group-item-action" data-aos="fade-left"
                        data-aos-duration="0900">
                        <div class="d-flex w-100 justify-content-between">
                            <h5 class="mb-1">Era 4.0, Saatnya Anak Belajar Coding Sejak Dini Secara Fun Demi Masa Depan
                            </h5>
                        </div>
                    </a>
                </div>
