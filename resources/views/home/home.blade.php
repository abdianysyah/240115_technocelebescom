@extends('master.master_home') @section('content')
                ...
                <div class="container">
                    <div class="d-flex align-items-start" data-aos="fade-left" data-aos-duration="0800">
                        ...
                        <div>
                            ...
                            <p>
                                "Pilih kami karena kami menghadirkan desain website yang kreatif dan responsif. Dengan perpaduan estetika yang menarik dan fungsionalitas responsif, kami memastikan setiap website mencerminkan identitas unik
                                bisnis Anda."
                            </p>
                        </div>
                    </div>
                    <div class="d-flex align-items-start" data-aos="fade-left" data-aos-duration="1000">
                        ...
                        <div class="ms-3">
                            <h3 class="fw-bold fs-4" style="font-family: 'poppins';">Pengalaman Terbukti dan Reputasi Positif</h3>
                            <p>
                                "Percayakan proyek website Anda kepada kami karena kami membawa pengalaman terbukti dalam industri ini. Reputasi positif kami dibangun atas dasar kepuasan klien dan hasil luar biasa. Bergabunglah dengan
                                mereka yang telah memilih kualitas dan keandalan."
                            </p>
                        </div>
                    </div>
                    <div class="d-flex align-items-start" data-aos="fade-left" data-aos-duration="1200">
                        ...
                        <div class="ms-3">
                            <h3 class="fw-bold fs-4" style="font-family: 'poppins';">Tim Profesional dan Pelayanan Personal</h3>
                            <p>
                                "Kenapa memilih kami? Kami memiliki tim profesional yang tidak hanya mahir dalam teknologi terkini, tetapi juga berkomitmen memberikan pelayanan personal. Bersama kami, Anda akan merasakan dukungan dan
                                pengertian penuh terhadap visi dan tujuan Anda."
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="caption-kerja" data-aos="fade-right" data-aos-duration="0800">
                    ...
                    <p>"Setiap proyek kami dimulai dengan konsultasi mendalam untuk memahami visi dan tujuan bisnis Anda. Percakapan ini menjadi landasan bagi desain dan pengembangan website yang sesuai."</p>
                </div>
                <div class="caption-kerja" data-aos="fade-right" data-aos-duration="0900">
                    ...
                    <p>"Perencanaan bersama adalah kunci keberhasilan. Kami melibatkan Anda dalam setiap tahap, mulai dari perencanaan hingga implementasi. Kolaborasi yang erat memastikan setiap elemen sesuai dengan harapan Anda."</p>
                </div>
                <div class="caption-kerja" data-aos="fade-right" data-aos-duration="1000">
                    ...
                    <p>
                        "Setiap website yang kami buat adalah unik, dibangun sesuai dengan kebutuhan khusus Anda. Kami memahami bahwa setiap bisnis memiliki karakteristiknya sendiri, dan itulah mengapa kami fokus pada pengembangan yang
                        disesuaikan."
                    </p>
                </div>
                <div class="caption-kerja" data-aos="fade-right" data-aos-duration="1100">
                    ...
                    <p>
                        "Kami memprioritaskan komunikasi yang transparan. Melalui platform yang terbuka dan jelas, kami memberikan pembaruan berkala tentang perkembangan proyek. Anda selalu tahu apa yang terjadi dan bagaimana proyek Anda
                        berkembang."
                    </p>
                </div>
            </div>
                ...
                <div class="owl-carousel">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="card border-secondary mx-auto rounded-3" style="width: 18rem;">
                            <div class="card-header"><img src="https://placekitten.com/100/100" class="rounded-circle my-4 mx-auto" style="width: 10rem;" alt="Profile Picture" /></div>
                            <div class="card-body">
                                <div class="ratings">
                                ...
                                <p class="card-title testimonial-name fs-5 fw-bold">Qodri</p>
                                <p class="card-text testimonial-impression">"Website mereka sungguh luar biasa! Desain yang keren dan layanan pembuatan website yang sangat profesional."</p>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="card border-secondary mx-auto" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-title testimonial-name fs-5 fw-bold">Iqbal</p>
                                <p class="card-text testimonial-impression">"Terima kasih kepada tim pembuat website ini. Hasilnya beyond expectations! Sempurna!"</p>
                            </div>
                            <div class="card-footer p-2">
                                <a href="https://www.facebook.com/" target="_blank" class="btn btn-secondary btn-square rounded-circle m-1">
                                    <i class="fab fa-facebook-f"></i>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="card border-secondary mx-auto" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-title testimonial-name fs-5 fw-bold">Nailul</p>
                                <p class="card-text testimonial-impression">"Website saya sekarang terlihat begitu menakjubkan, semua berkat bantuan ahli dari platform ini."</p>
                            </div>
                            <div class="card-footer p-2">
                                <a href="https://www.facebook.com/" target="_blank" class="btn btn-secondary btn-square rounded-circle m-1">
                                    <i class="fab fa-facebook-f"></i>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="card border-secondary mx-auto" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-title testimonial-name fs-5 fw-bold">Surya</p>
                                <p class="card-text testimonial-impression">"Pembuatan website jadi lebih mudah dan menyenangkan! Desain yang modern dan pelayanan yang sangat ramah."</p>
                            </div>
                            <div class="card-footer p-2">
                                <a href="https://www.facebook.com/" target="_blank" class="btn btn-secondary btn-square rounded-circle m-1">
                                    <i class="fab fa-facebook-f"></i>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="card border-secondary mx-auto" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-title testimonial-name fs-5 fw-bold">Mas Alif</p>
                                <p class="card-text testimonial-impression">"Sangat puas dengan website baru saya! Proses pembuatannya cepat dan hasilnya sungguh memukau."</p>
                            </div>
                            <div class="card-footer p-2">
                                <a href="https://www.facebook.com/" target="_blank" class="btn btn-secondary btn-square rounded-circle m-1">
                                    <i class="fab fa-facebook-f"></i>
                        ...
                        <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample" style="border-radius: 30px;">
                            <div class="accordion-body">
                                <p class="text-secondary">
                                    Pembayaran hanya dilakukan di rekening CV Techno Celebes atau melalui cash di kantor CV Techno Celebes. Jika terdapat pihak yang ingin membayar di luar dari ketentuan di atas, maka itu di luar dari
                                    tanggung jawab kami. <br />
                                    <br />
