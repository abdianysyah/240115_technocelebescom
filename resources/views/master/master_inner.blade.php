...
<head>
    ...
    <link rel="stylesheet" href="{{asset('theme/home/plugin/bootstrap-icon/bootstrap-icons.min.css')}}" />
    <link rel="stylesheet" href="{{asset('theme/home/plugin/OwlCarousel2-2.3.4/assets/owl.carousel.min.css')}}" />
    <link rel="stylesheet" href="{{asset('theme/home/plugin/OwlCarousel2-2.3.4/assets/owl.theme.default.min.css')}}" />
...
<body>
    @include('layout.home.header_inner')
    @yield('content')
    ...
    <script src="{{asset('theme/home/js/home.js')}}"></script>
    <script>
        AOS.init();
    </script>
</body>
